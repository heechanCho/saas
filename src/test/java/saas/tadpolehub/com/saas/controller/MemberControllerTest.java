...
public class MemberControllerTest {
    ...
    public Member createMember(String email, String password, String passwordCheck) {
        MemberFormDto memberFormDto = new MemberFormDto();
        memberFormDto.setEmail(email);
        memberFormDto.setName("name");
        memberFormDto.setAddress("address");
        memberFormDto.setPassword(password);
        memberFormDto.setPasswordCheck(passwordCheck);
    ...
    public void loginSuccessTest() throws Exception {
        ...
        this.createMember(email, password, passwordCheck);
